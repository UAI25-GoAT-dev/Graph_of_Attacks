...
from config import VICUNA_PATH, LLAMA_PATH, ATTACK_TEMP, TARGET_TEMP, ATTACK_TOP_P, TARGET_TOP_P, MAX_PARALLEL_STREAMS, CACHE_DIR, _MIXTRAL__PATH, _VICUNA_13_PATH, _VICUNA_13_16_PATH, _VICUNA_7_PATH, _Llama_7_PATH
...
class AttackLLM():
    ...
    def get_attack(self, convs_list, prompts_list, graph, depth, n_sample):
        """
        ...
        for conv, prompt in zip(convs_list, prompts_list):
            ...
            full_prompts.append(get_prompt(conv, graph, depth, n_sample))
        ...
        if any([output for output in valid_outputs if output is None]): # It's always False!
...
def load_indiv_model(model_name):
    ...
    if model_name in ["gpt-3.5-turbo", "gpt-4"]:
        ...
        cache_dir = CACHE_DIR if ((model_name=="_mixtral_") or (model_name=="_vicuna_13") or (model_name=="_vicuna_7") or (model_name=="_llama-2-chat-hf_7")) else None
...
def get_model_path_and_template(model_name):
    full_model_dict={
        ...
        "_vicuna_13":{
            "path":_VICUNA_13_PATH,
            "template":"vicuna_v1.1"
        },
        "_vicuna_13.16":{
            "path":_VICUNA_13_16_PATH,
            "template":"vicuna_v1.1"
        },
        "_vicuna_7":{
            "path":_VICUNA_7_PATH,
